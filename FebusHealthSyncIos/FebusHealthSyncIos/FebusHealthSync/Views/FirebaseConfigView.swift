            ...
            VStack(spacing: 25) {
                ...
                VStack(alignment: .leading, spacing: 12) {
                    ...
                    TextEditor(text: $plistContent)
                        ...
                        .onChange(of: plistContent) { newValue in
                ...
                VStack(alignment: .leading, spacing: 10) {
                    ...
                    if showManualConfig {
                        VStack(spacing: 15) {
                            ...
                            customTextField(title: "Google Client ID", text: $clientID, placeholder: "215284107318-22qlq74hp88c8n...")
                        }
                        .transition(.slide)
                    }
                }
                ...
                .disabled(isValidating || (apiKey.isEmpty || projectID.isEmpty || googleAppID.isEmpty || clientID.isEmpty))
                .padding(.horizontal, 30)
                .padding(.top, 10)
